/*
clear && gcc basic-tutorial-8.c -o basic-tutorial-8 `pkg-config --cflags --libs gstreamer-1.0 gstreamer-audio-1.0` && ./basic-tutorial-8
*/
...
#elif defined (spectrascope)
  /* simple frequency spectrum scope */
  data.visual = gst_element_factory_make ("spectrascope", "visual");
#elif defined (synaescope)
  /* Creates video visualizations of audio input, using stereo and pitch */
  // information
